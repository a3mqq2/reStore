...
<div class="mt-4">
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header bg-primary text-white">تعديل السؤال الشائع</div>
                ...
                <div class="card-body">
                    <form action="{{ route('faqs.update', $faq->id) }}" method="POST">
                        ...
                        <div class="mb-3 form-check">
                            <input type="checkbox" name="is_active" id="is_active" class="form-check-input @error('is_active') is-invalid @enderror" {{ old('is_active', $faq->is_active) ? 'checked' : '' }} value="1">
                        ...
                        <button type="submit" class="btn btn-success">تحديث السؤال الشائع</button>
