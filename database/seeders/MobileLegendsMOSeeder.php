...
class MobileLegendsMOSeeder extends Seeder
{
    /**
     * استخدام: php artisan db:seed --class=MobileLegendsMOSeeder
     */
    public function run(): void
    {
        $moogoldId = 15145;
        $name = 'Mobile Legends (MO)';
        ...
        try {
            ...
            Log::error('MobileLegendsMO Seeder Error', ['error' => $e->getMessage(), 'trace' => $e->getTraceAsString()]);
        }
    }
}
