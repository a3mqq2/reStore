...
class LoveAndDeepspaceSeeder extends Seeder
{
    /**
     * استخدام: php artisan db:seed --class=LoveAndDeepspaceSeeder
     */
    public function run(): void
    {
        ...
        try {
            ...
            Log::error('LoveAndDeepspace Seeder Error', ['error' => $e->getMessage(), 'trace' => $e->getTraceAsString()]);
        }
    }
}
